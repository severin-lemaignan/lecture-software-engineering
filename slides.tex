...
add_executable(pathfinding_ui pathfinding main.cpp ui.cpp)
target_link_libraries(pathfinding_ui ${OpenCV_LIBRARIES})
...
joe@doe:/usr/project$ ls -alh
drwxr-xr-x  2 joe  root       4.0K Sep 22 10:40 .
drwxr-xr-x 12 root root       4.0K Sep 22 10:36 ..
-rwxrwxr-x  1 joe  joe        8.8K Sep 22 10:40 app
-rw-rw-r--  1 joe  joe        2.1K Sep 22 10:39 compile.sh
-rw-rw-r--  1 joe  joe         134 Sep 22 10:39 how-to-compile.txt
-rw-rw-r--  1 joe  joe         895 Sep 22 10:38 main.cpp
-rw-rw-r--  1 joe  joe        1.2K Sep 22 10:38 main.hpp
-rw-rw-r--  1 joe  joe        5.8K Sep 22 10:40 main.o
-rw-rw-r--  1 joe  joe          50 Sep 22 10:36 main.ini
-rw-rw-r--  1 joe  joe        2.3K Sep 22 10:40 sound-lib.cpp
-rw-rw-r--  1 joe  joe         230 Sep 22 10:40 sound-lib.hpp
-rw-rw-r--  1 joe  joe        4.3K Sep 22 10:40 sound-lib.o
-rw-rw-r--  1 joe  joe        5.3K Sep 22 10:40 sound-lib.a
-rw-rw-r--  1 joe  joe        6.7K Sep 22 10:40 ui-lib.cpp
-rw-rw-r--  1 joe  joe         874 Sep 22 10:40 ui-lib.hpp
-rw-rw-r--  1 joe  joe        7.1K Sep 22 10:40 ui-lib.o
-rw-rw-r--  1 joe  joe        7.6K Sep 22 10:40 ui-lib.so
\end{minted}
...
\end{onlyenv}
    ...
    \begin{onlyenv}<2>
        ...
        \begin{itemize}
            ...
            \item Inconsistent use of static and dynamic libraries
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section[Licenses]{Softawre Licenses, Open-source, free software}
...
\begin{frame}[plain]
        ...
        \normalsize
        Questions:\\
        Portland Square B316 or \url{severin.lemaignan@plymouth.ac.uk} 
